...
class ApiClient extends GetxService {
  ...
  static Future<Response> getData(
    ...
    final isConnected = await ConnectivityHelper.checkConnection();
    if (!isConnected) {
...
class ConnectivityHelper {
  ...
  static Future<bool> checkConnection() async {
    ...
    final isConnected = results.any((r) => r != ConnectivityResult.none);
    return _handleStatus(isConnected);
  }

  static bool _handleStatus(bool isConnected) {
    if (!isConnected && isOffline.value == false) {
      isOffline.value = true;
      _snackController = Get.snackbar(
        'No Internet',
    ...
    } else if (isConnected && isOffline.value == true) {
